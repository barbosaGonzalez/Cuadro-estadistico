...
//*      Programa de Cuadro Estadistico    *
//******************************************
...
namespace Estadistica
{
    public partial class frmSecundario : Form
    {
        ...
        //Cuando el se Carga el Formulario
        private void Form1_Load(object sender, EventArgs e)
        {

            //Poner el Cursor en el TextBox
            txtValor.Select();
            ...
            Cuadro_Estadistico.Columns.Add("Grados (C)");   //Se define el Nombre de la primera Columna
        ...
        private void txtValor_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                //Agregamos a la lista Desordenada el numero que se dijita Caja de Texto
                lsbDesordenada.Items.Add(int.Parse(txtValor.Text));
                ...
                //Limpiar la Tabla
                Cuadro_Estadistico.Rows.Clear();

                //Limpiar las Graficas
                GraficaHistograma.Series[0].Points.Clear();   //Grafica de Pasteles
                GraficaPasteles.Series[0].Points.Clear();   //Grafica de Pasteles
                GraficaPoligonal.Series[0].Points.Clear();   //Grafica Poligonal
        ...
        {
            txtRango.Clear();                //Borra lo que tenga la caja de Texto de Rango
            txtDesviacion.Clear();           //Borra lo que tenga la caja de Texto de Desviacion
            txtMuestra.Clear();              //Borra lo que tenga la caja de Texto de Muestra
            txtMedia.Clear();                //Borra lo que tenga la caja de Texto de Media Aritmetica
            txtMediana.Clear();              //Borra lo que tenga la caja de Texto de Mediana
            txtModa.Clear();                 //Borra lo que tenga la caja de Texto de Moda
            txtSumatoria.Clear();            //Borra lo que tenga la caja de Texto de Sumatoria
            txtValor.Clear();                //Borra lo que tenga la caja de Texto de Valor
            txtIntervalo.Clear();            //Borra lo que tenga la caja de Texto de Intervalo de Clase
            txtCoeficiente.Clear();          //Borra lo que tenga la caja de Texto de Coeficiente de Variación
            txtAlcance.Clear();              //Borra lo que tenga la caja de Texto de Alcance
            txtDesviacionMedia.Clear();      //Borra lo que tenga la caja de Texto de Desviacion Media
            txtMaximo.Clear();
            txtMinimo.Clear();               //Borra lo que tenga la caja de Texto del Valor Minimo
            txtVarianza.Clear();             //Borra lo que tenga la caja de Texto de Varianza
            lsbDesordenada.Items.Clear();    //Borra lo que tenga la Lista del Vector Desordenado
            lsbOrdenada.Items.Clear();       //Borra lo que tenga la Lista del Vector Ordenado
            Cuadro_Estadistico.Rows.Clear(); //Limpia la Tabla
            GraficaHistograma.Series[0].Points.Clear();   //Limpia la Grafica de Barra
            GraficaPasteles.Series[0].Points.Clear();     //Limpia la Grafica de Pasteles
            GraficaPoligonal.Series[0].Points.Clear();    //Limpia la Grafica Poligonal
